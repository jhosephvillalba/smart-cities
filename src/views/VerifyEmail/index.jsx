...
const VerifyEmail = ({ darkMode }) => {
    ...
    const handleVerification = async () => {
        ...
        try {
            ...
            console.error(error);
            setErrorMessage('Hubo un problema al verificar tu correo. Inténtalo de nuevo.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="text_section">
            <div className={`row justify-content-center align-items-center ${styles.section_content}`}>
                {!verified ? (
                    <div className="col-md-6">
                        <div className="w-100 d-flex justify-content-between align-items-center mb-5">
                            ...
                            <div className="text-center w-100 d-flex justify-content-center">
                                <p className="fs-4 fw-bolder m-0 title-section">Verificación de Email</p>
                            </div>
                        ...
                        <div className="d-flex flex-column align-items-center">
                            <p className="text-center mb-4">Confirma tu cuenta haciendo clic en el botón que verás a continuación.</p>
                            <button
